...
import { BarChart3, Flame, TrendingDown, Trophy } from "lucide-react";
...
const Trends: React.FC = () => {
  ...
  const getFilteredTrends = (type: "streak" | "slump" | "career") => {
    return trends.filter(
      (trend) => trend.sport === selectedSport && trend.trendType === type
    );
  };
    ...
    <div className="trends-container">
      <div className="trends-header">
        ...
        <p className="trends-subtitle">
          Track hot streaks, slumps, and career milestones
        </p>
      </div>
              ...
              <div key={trend.id} className="player-card streak-card">
                ...
                <div className="betting-section">
                  <div className="betting-line">
                    <span className="line-label">
                      Line: {trend.bettingRelevance.line}
                    </span>
                    <span
                      className={`recommendation ${trend.bettingRelevance.recommendation}`}
                    >
                  ...
                  <div
                    className={`confidence ${getConfidenceColor(
                      trend.bettingRelevance.confidence
                    )}`}
                  >
                ...
                <div className="next-game">
                  ...
                  <span className="venue">
                    {trend.nextGame.homeAway === "home" ? "🏠" : "✈️"}
                  </span>
                </div>
              </div>
            ))}
          ...
          <div className="column-content">
                ...
                <div className="trend-details">
                  <div className="trend-stat">
                    <span className="stat-value">
                      ...
                      {trend.careerRank && (
                        <span className="rank">#{trend.careerRank}</span>
                      )}
                    </span>
                    <span className="stat-label">
                      {trend.bettingRelevance.prop}
            ...
            {careerHighs.length === 0 && (
              <div className="no-data">
                No career milestones for {selectedSport}
              </div>
            )}
          </div>
        </div>
